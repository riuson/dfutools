...
using DfuToolCli.Tools.Targets.Remove;
using NUnit.Framework;
using System;
using System.IO;

namespace DfuToolCli.Tests.Tools.Targets.Remove {
    [TestFixture]
    public class ProcessorTests : BaseTestFixture {
        [Test]
        public void CanProcessInternalById() {
            // Sample.
            var sample = new byte[] {
            ...
            using (var stream = new MemoryStream()) {
                ...
                sut.ProcessInternal(stream, 0, -1);
        ...
        public void CanProcessInternalSpecificId() {
            ...
            using (var stream = new MemoryStream()) {
                ...
                sut.ProcessInternal(stream, -1, 1);
