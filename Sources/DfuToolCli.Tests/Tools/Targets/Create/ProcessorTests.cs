...
using DfuToolCli.Tools.Targets.Create;
using NUnit.Framework;
using System;
using System.IO;

namespace DfuToolCli.Tests.Tools.Targets.Create {
    [TestFixture]
    public class ProcessorTests : BaseTestFixture {
        ...
        public void CanTargetCreateAutoId() {
            ...
            var expected = new byte[] {
                ...
                0x72, 0x72, 0x72, 0x72, 0x72, 0x72, 0x72, 0x72,
                0x72, 0x72, 0x72, 0x72, 0x72, 0x72, 0x72, 0x72,
                0x72, 0x72, 0x72, 0x72, 0x72, 0x72, 0x72,
                0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00,
            ...
            using (var stream = new MemoryStream()) {
                ...
                sut.ProcessInternal(stream, -1, new string('r', 255));
        ...
        public void CanTargetCreateSpecificId() {
            ...
            using (var stream = new MemoryStream()) {
                ...
                sut.ProcessInternal(stream, 0xfe, new string('r', 255));
