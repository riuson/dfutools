...
using DfuToolCli.Tools.Elements.Remove;
using NUnit.Framework;
using System;
using System.IO;

namespace DfuToolCli.Tests.Tools.Elements.Remove {
    [TestFixture]
    public class ProcessorTests : BaseTestFixture {
        [Test]
        public void CanCreateElementBinaryById() {
            // Sample.
            var sample = new byte[] {
            ...
            using (var dfuStream = new MemoryStream()) {
                ...
                sut.ProcessInternal(dfuStream, 1, 0);
